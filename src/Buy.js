...
() {
  const obj=[
    ...
    {
        "imageurl": [
            "https://m.media-amazon.com/images/M/MV5BNjY0MWZiNDQtMDk3My00MTZmLWI2ZGEtYWUxOTgyMzNjNTYwXkEyXkFqcGdeQXVyMTA0MjU4MDQ0._V1_UY268_CR16,0,182,268_AL_.jpg"
        ],
        "genre": [
            "Action"
        ],
    ...
    },
    {
        ...
        "imdbid": "tt10558706",
        "title": "Commandos: The Mission",
        "imdbrating": 6.5,
        "released": 2020,
        "type": "movie",
        "synopsis": "Six Dutch Commandos, commanded by John de Koning and stationed in Mali, are sent to Nigeria under American orders to free the son of a wealthy Nigerian oil family from Boko Haram rebels. ..."
    },
    {
        "imageurl": [
            "https://m.media-amazon.com/images/M/MV5BYThmODBlYjItOGRjYi00OWExLTg4MTEtMTAyOGU2MTFiOWE0XkEyXkFqcGdeQXVyNTM5ODc4MzE@._V1_UX182_CR0,0,182,268_AL_.jpg"
        ],
        "genre": [
            "Action",
            "Western"
        ...
        "imdbid": "tt10398376",
        "title": "Gunfight at Silver Creek",
        "imdbrating": 7.2,
        "released": 2020,
        "type": "movie",
        "synopsis": ""
    ...
    {
        "imageurl": [
            "https://m.media-amazon.com/images/M/MV5BZjQzNmQwZjMtMzU3OS00MDgzLTllM2YtMmQzZmViYmY0NWQ3XkEyXkFqcGdeQXVyNzk5OTM5ODg@._V1_UY268_CR12,0,182,268_AL_.jpg"
        ],
        "genre": [
            "Action",
            "Animation"
        ...
        "imdbid": "tt10152746",
        "title": "Justice League: Invasion",
        "imdbrating": 6.7,
        "released": 2020,
        "type": "movie",
        "synopsis": "A nightmare has arrived, the Invasion is here. Darkseid of Apokolips has set to Earth after a Mother Box is opened. Earth's heroes are soon to bring justice against Darkseid's inevitable strength."
    },
    {
        "imageurl": [
  ...
  const [allmovie,setAllMovie]=useState(obj)
  ...
  return (
    <div>
      ...
      <div class='Main'> 
      <div style={{"color":"white"}}><h1>Welcome, {myState.username}</h1></div>
      <br></br>
      <div clas="search">
     
      <input placeholder="search tv shows" onChange={handle}></input>
      <button onClick={handleButton}>search</button>

      </div>
      <div><Link to="/favourites">View Favourites</Link></div>
      <br></br>
